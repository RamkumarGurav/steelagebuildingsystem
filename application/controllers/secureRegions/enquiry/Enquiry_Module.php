...
class Enquiry_Module extends Main
{
	...
	function index()
	{
		parent::get_header();
		parent::get_left_nav();
		$this->load->view('admin/enquiry/Enquiry_Module/listings', $this->data);
		parent::get_footer();
	}
	...
	function view($enquiry_id = "")
	{
		...
		parent::get_header();
		parent::get_left_nav();
		$this->load->view('admin/enquiry/Enquiry_Module/view', $this->data);
		parent::get_footer();
	}
	...
	function edit($enquiry_id = "")
	{
		...
		parent::get_header();
		parent::get_left_nav();
		$this->load->view('admin/enquiry/Enquiry_Module/edit', $this->data);
		parent::get_footer();
	}
