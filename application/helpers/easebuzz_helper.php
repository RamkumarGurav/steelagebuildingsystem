<?php
    // include file
    include_once(APPPATH.'third_party/easebuzz/easebuzz-lib/easebuzz_payment_gateway.php');
    ...
    */
        ...
        */
		...
		function easebuzzAPIFunc($data, $apiname)
		{
			...
			*/
			...
			if($apiname === "initiate_payment"){
			  ...
			  //  print_r($_POST);
				...
				*/
				return $easebuzzObj->initiatePaymentAPI($data, false);
