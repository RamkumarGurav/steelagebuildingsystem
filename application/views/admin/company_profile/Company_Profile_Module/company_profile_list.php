						...
						<div class="row">
							<div class="col-md-6">
								...
								<select name="field_name" id="field_name" class="form-control" style="width: 100%;">
									...
									<option value='aau.name' <?php  if($field_name=='aau.company_unique_name'){echo 'selected';} ?>>Company Unique Name</option>
									<option value='aau.company_name' <?php  if($field_name=='aau.company_name'){echo 'selected';} ?>>Company Name</option>
									<option value='aau.name' <?php  if($field_name=='aau.name'){echo 'selected';} ?>>Name</option>
									...
									<option value='aau.gst_no' <?php  if($field_name=='aau.gst_no'){echo 'selected';} ?>>GST No.</option>
								</select>
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php  } ?>
										<td><a href="<?php  echo MAINSITE_Admin.$user_access->class_name."/company-profile-view/".$urm->company_profile_id?>"><?php  echo $urm->company_unique_name	?></a></td>
