								...
								<tr>
                                    ...
                                    <tr>
                                        ...
                                        <strong class="full">Message</strong>
                                         <?=$enquiry_data->message?></td>
                                         <td>
                                        <strong class="full">IP Address</strong>
                                         <?=$enquiry_data->ip_address?></td>
                                         <td >
                                        <strong class="full">Page link</strong>

                                        <?php if($enquiry_data->page_link=="home_page"): ?>
                                            <a
                                            href="<?= MAINSITE ?>"><?= $enquiry_data->page_link ?></a>
                                        <?php else: ?>
                                            <a
                                            href="<?= MAINSITE.$enquiry_data->page_link ?>"><?= $enquiry_data->page_link ?></a>
                                        <?php endif; ?>
