...
<!-- AdminLTE App -->
<script src="<?=_lte_files_?>dist/js/adminlte.js"></script>
...
<!-- PAGE PLUGINS -->
<!-- jQuery Mapael -->
<script src="<?=_lte_files_?>plugins/jquery-mousewheel/jquery.mousewheel.js"></script>
<script src="<?=_lte_files_?>plugins/raphael/raphael.min.js"></script>
<script src="<?=_lte_files_?>plugins/jquery-mapael/jquery.mapael.min.js"></script>
<script src="<?=_lte_files_?>plugins/jquery-mapael/maps/usa_states.min.js"></script>
<!-- ChartJS -->
<script src="<?=_lte_files_?>plugins/chart.js/Chart.min.js"></script>

<!-- PAGE SCRIPTS -->
<script src="<?=_lte_files_?>dist/js/pages/dashboard2.js"></script>
