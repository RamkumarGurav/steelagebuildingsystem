						...
						<div class="row">
							<div class="col-md-6">
								...
								<select name="field_name" id="field_name" class="form-control" style="width: 100%;">
									...
									<option value='urm.department_name' <? if($field_name=='urm.department_name'){echo 'selected';} ?>>Department</option>
								</select>
                            ...
                            <table id="example1" class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <? } ?>
                                        <td><a href="<?=MAINSITE_Admin.$user_access->class_name."/department-view/".$urm->department_id?>"><?=$urm->department_name	?></a></td>
