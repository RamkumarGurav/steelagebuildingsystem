					  ...
					  <div class="card-body">
						<div class="row">
							<div class="col-md-6">
								...
								<select name="field_name" id="field_name" class="form-control" style="width: 100%;">
									...
									<option value='urm.state_name' <? if($field_name=='urm.state_name'){echo 'selected';} ?>>State</option>
									<option value='urm.state_code' <? if($field_name=='urm.state_code'){echo 'selected';} ?>>State Code</option>
								</select>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label>Country</label>
									<select type="text" class="form-control" id="country_id" name="country_id" style="width: 100%;">
                            ...
                            <table id="example1" class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <? } ?>
										<td><a href="<?=MAINSITE_Admin.$user_access->class_name."/state-view/".$urm->state_id?>"><?=$urm->state_name	?></a></td>
                                        <td><?=$urm->country_name?></td>
                                        <td><?=$urm->state_code?></td>
										<td>
